(function () {
    ...
    //编译新品推荐数据
    var newRecommendBoxTpl= $('#newRecommend-box').html();
    var newRecommendBox=Handlebars.compile(newRecommendBoxTpl);
            ...
            success:function (data) {
                if(data.errorCode==200){
                    ...
                    if (data.list.length > 0) {
                        $('.newRecommend-box').append(newRecommendBox(data));
                        //图片懒加载初始化
                        $(function() {
                            $("img.lazy").lazyload()
                        });
